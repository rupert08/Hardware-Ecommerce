...
class AddressFactoryTest {
    ...
    void b_createApartmentAddress_success() {
        Address address = AddressFactory.createAddress("2", "", "", "Sunset Complex", "A12", "Main Street", "Capetown", "Western Cape", "8008", customer);
        assertNotNull(address);
        System.out.println(address);
    }
    ...
    void c_createUnitAddress_success() {
        Address address = AddressFactory.createAddress("5", "3B", "", "Highrise Building", "", "Main Street", "Capetown", "Western Cape", "8008", customer);
        assertNotNull(address);
        System.out.println(address);
    }
    ...
    void f_createAddress_failed_missingEssentialFields() {
        Address address = AddressFactory.createAddress("", "", "", "", "", "", "Capetown", "Western Cape", "8008", customer);
        assertNotNull(address);
    ...
    void g_createAddress_failed_invalidApartmentCombination() {
        Address address = AddressFactory.createAddress("", "", "", "Sunset Complex", "", "Main Street", "Capetown", "Western Cape", "8008", customer);
        assertNotNull(address);
        System.out.println(address.toString());
    }
    ...
    void h_createAddress_failed_invalidUnitCombination() {
        Address address = AddressFactory.createAddress("", "3B", "", "", "", "Main Street", "Capetown", "Western Cape", "8008", customer);
        assertNotNull(address);
        System.out.println(address.toString());
    }
