...
class PaymentFactoryTest {
    ...
    private Order createValidOrder() {
        ...
        Shipping shipping = ShippingFactory.createShipping(address, OrderStatus.PENDING, 50.0f);
        return OrderFactory.buildOrder(cart, LocalDate.now(), shipping, 200.0f, "PENDING");
    }
